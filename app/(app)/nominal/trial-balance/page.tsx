...
export default async function TrialBalancePage({
  ...
  const [tb, landlordRows] = await Promise.all([
    getTrialBalance({ asOf, landlordId }),
  ...
  return <TrialBalanceClient tb={tb} asOf={asOf} landlordId={landlordId} landlords={landlords} />;
}
