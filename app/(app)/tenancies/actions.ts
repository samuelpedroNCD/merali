...
const Schema = z.object({
  ...
  payment_timing: z.preprocess(s, z.string().nullable()),
  quarter_type: z.preprocess(s, z.string().nullable()),
  due_weekday: z.preprocess((v) => (v === "" || v == null ? null : Number(v)), z.number().int().nullable()),
  due_dom: z.preprocess((v) => (v === "" || v == null ? null : Number(v)), z.number().int().nullable()),
  custom_due_dates: z.array(z.string()).default([]),
