...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Trial balance", href: "/nominal/trial-balance", icon: Scale, module: "finance" },
      { label: "VAT return", href: "/nominal/vat-return", icon: Percent, module: "finance" },
      { label: "Bank accounts", href: "/bank-accounts", icon: Landmark, module: "finance" },
      { label: "Receipt batches", href: "/receipts", icon: Layers, module: "finance" },
